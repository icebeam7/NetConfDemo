...
{
    public class DrawViewControlAndroid : View
    {
        //drawing path
        ...
        public DrawViewControlAndroid(Context context, IAttributeSet attrs, int defStyle) : base(context, attrs, defStyle)
        {
            Initialize();
        }

        public DrawViewControlAndroid(Context context, IAttributeSet attrs) : base(context, attrs)
        {
            Initialize();
        }

        public DrawViewControlAndroid(Context context) : base(context)
        {
            Initialize();
        }
        ...
        public void Save()
        {
            if (MainActivity.Instance.CheckSelfPermission(Manifest.Permission.WriteExternalStorage) 
